...
.config(function($routeProvider){
	...
	$routeProvider.when('/', {
		templateUrl: '/ng_asparticipant/views/dashboard.html',
...
// 
.controller('DashboardController', function($rootScope, $scope, $location, $route, $cookieStore, ActivityService, AlertService, Socket){
	...
	$scope.paginate = function(page){
		ActivityService.FindAll(participantId, page).success(function(res, status){
			if(res.result){
				$scope.result = true;
